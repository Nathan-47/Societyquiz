const socData = [
  ...
  },
  {
    ...
    linkA: "results.html?category=Active%20%26%20Performance",
    answerB: "Pushing yourself physically, on a team, training, or competing",
    linkB: "https://www.bcusu.com/get-involved/student-groups/#sports",
  },
  {
    question: "What kind of people do you hope to meet?",
    id: 3,
    answerA:
      "Passionate creators/students that are into gaming, media, film, photography, podcasting",
    linkA: "results.html?category=General Interest",
  ...
  },
  {
    ...
    linkB: "results.html?category=Protected",
  },
  {
    ...
    linkA: "results.html?category=Faith%20%26%20Culture",
    answerB: "I don't know yet, still figuring it out",
